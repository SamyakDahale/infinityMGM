...
VOICE_OPTIONS = {
    ...
    "Krishna (Indian , Southern)" : "F4AXgTwG8nWPB9dcXaTh"  ,  
    "Shiva (Indian Boy, Nothern)" : "Mbwx1ZAXuMdYGtJRjvvQ" ,
    "Rekha (Indian Boy, Nothern)":"UYoWPkHjaRgjWccloxC5",
    "Ramaswamy (Indian Boy, Southern)":"oJtqFwbHKS0pFD03MNRd"
}
